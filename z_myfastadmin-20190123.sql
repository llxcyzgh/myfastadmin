...
-- 正在导出表  myfastadmin.fa_admin 的数据：~0 rows (大约)
...
INSERT INTO `fa_admin` (`id`, `username`, `nickname`, `password`, `salt`, `avatar`, `email`, `loginfailure`, `logintime`, `createtime`, `updatetime`, `token`, `status`) VALUES
	(1, 'admin', 'Admin', '2517f0ebc0eb7e8866300e1ecdb26a8d', '47ae02', '/assets/img/avatar.png', 'admin@admin.com', 0, 1548222318, 1492186163, 1548222318, '2cc30b03-eeeb-4b45-96dd-c1ebf78da647', 'normal');
/*!40000 ALTER TABLE `fa_admin` ENABLE KEYS */;

-- 导出  表 myfastadmin.fa_admin_log 结构
CREATE TABLE IF NOT EXISTS `fa_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员日志表';

-- 正在导出表  myfastadmin.fa_admin_log 的数据：~13 rows (大约)
...
INSERT INTO `fa_admin_log` (`id`, `admin_id`, `username`, `url`, `title`, `content`, `ip`, `useragent`, `createtime`) VALUES
	(1, 1, 'admin', '/index.php/admin/index/login', '登录', '{"__token__":"635b23ed7a2e19081a3bd271c48d1d35","username":"admin","captcha":"8tdf"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215952),
	(2, 1, 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{"name":"example","faversion":"1.0.0.20190111_beta"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215979),
	(3, 1, 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{"name":"summernote","faversion":"1.0.0.20190111_beta"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215980),
	(4, 1, 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{"name":"database","faversion":"1.0.0.20190111_beta"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215981),
	(5, 1, 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{"name":"wechat","faversion":"1.0.0.20190111_beta"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215982),
	(6, 1, 'admin', '/index.php/admin/addon/install', '插件管理 安装', '{"name":"command","faversion":"1.0.0.20190111_beta"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215983),
	(7, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215984),
	(8, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215986),
	(9, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215988),
	(10, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215989),
	(11, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548215991),
	(12, 1, 'admin', '/admin/index/login?url=%2F', '登录', '{"url":"\\/","__token__":"be64f10f88770dfaef7496aaaf6037f3","username":"admin","captcha":"4qvb"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548222318),
	(13, 1, 'admin', '/admin/command/get_field_list', '', '{"table":"fa_admin"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 1548223198);
/*!40000 ALTER TABLE `fa_admin_log` ENABLE KEYS */;

-- 导出  表 myfastadmin.fa_area 结构
...
-- 正在导出表  myfastadmin.fa_area 的数据：~3,758 rows (大约)
...
-- 导出  表 myfastadmin.fa_attachment 结构
...
-- 正在导出表  myfastadmin.fa_attachment 的数据：~0 rows (大约)
...
-- 导出  表 myfastadmin.fa_auth_group 结构
...
-- 正在导出表  myfastadmin.fa_auth_group 的数据：~5 rows (大约)
...
-- 导出  表 myfastadmin.fa_auth_group_access 结构
...
-- 正在导出表  myfastadmin.fa_auth_group_access 的数据：~0 rows (大约)
...
-- 导出  表 myfastadmin.fa_auth_rule 结构
...
-- 正在导出表  myfastadmin.fa_auth_rule 的数据：~95 rows (大约)
...
INSERT INTO `fa_auth_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `condition`, `remark`, `ismenu`, `createtime`, `updatetime`, `weigh`, `status`) VALUES
	...
	(85, 'file', 0, 'example', '开发示例管理', 'fa fa-magic', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(86, 'file', 85, 'example/bootstraptable', '表格完整示例', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(87, 'file', 86, 'example/bootstraptable/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(88, 'file', 86, 'example/bootstraptable/detail', '详情', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(89, 'file', 86, 'example/bootstraptable/change', '变更', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(90, 'file', 86, 'example/bootstraptable/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(91, 'file', 86, 'example/bootstraptable/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(92, 'file', 85, 'example/customsearch', '自定义搜索', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(93, 'file', 92, 'example/customsearch/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(94, 'file', 92, 'example/customsearch/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(95, 'file', 92, 'example/customsearch/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(96, 'file', 85, 'example/colorbadge', '彩色角标', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(97, 'file', 96, 'example/colorbadge/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(98, 'file', 96, 'example/colorbadge/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(99, 'file', 96, 'example/colorbadge/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(100, 'file', 85, 'example/controllerjump', '控制器间跳转', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(101, 'file', 100, 'example/controllerjump/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(102, 'file', 100, 'example/controllerjump/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(103, 'file', 100, 'example/controllerjump/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(104, 'file', 85, 'example/cxselect', '多级联动', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(105, 'file', 104, 'example/cxselect/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(106, 'file', 104, 'example/cxselect/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(107, 'file', 104, 'example/cxselect/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(108, 'file', 85, 'example/multitable', '多表格示例', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(109, 'file', 108, 'example/multitable/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(110, 'file', 108, 'example/multitable/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(111, 'file', 108, 'example/multitable/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(112, 'file', 85, 'example/relationmodel', '关联模型示例', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(113, 'file', 112, 'example/relationmodel/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(114, 'file', 112, 'example/relationmodel/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(115, 'file', 112, 'example/relationmodel/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(116, 'file', 85, 'example/tabletemplate', '表格模板示例', 'fa fa-table', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(117, 'file', 116, 'example/tabletemplate/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(118, 'file', 116, 'example/tabletemplate/detail', '详情', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(119, 'file', 116, 'example/tabletemplate/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(120, 'file', 116, 'example/tabletemplate/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(121, 'file', 85, 'example/baidumap', '百度地图示例', 'fa fa-map-pin', '', '', 1, 1548215979, 1548215979, 0, 'normal'),
	(122, 'file', 121, 'example/baidumap/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(123, 'file', 121, 'example/baidumap/map', '详情', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(124, 'file', 121, 'example/baidumap/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215979, 1548215979, 0, 'normal'),
	(125, 'file', 2, 'general/database', '数据库管理', 'fa fa-database', '', '可在线进行一些简单的数据库表优化或修复,查看表结构和数据。也可以进行SQL语句的操作', 1, 1548215981, 1548215981, 0, 'normal'),
	(126, 'file', 125, 'general/database/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215981, 1548215981, 0, 'normal'),
	(127, 'file', 125, 'general/database/query', '查询', 'fa fa-circle-o', '', '', 0, 1548215981, 1548215981, 0, 'normal'),
	(128, 'file', 125, 'general/database/backup', '备份', 'fa fa-circle-o', '', '', 0, 1548215981, 1548215981, 0, 'normal'),
	(129, 'file', 125, 'general/database/restore', '恢复', 'fa fa-circle-o', '', '', 0, 1548215981, 1548215981, 0, 'normal'),
	(130, 'file', 0, 'wechat', '微信管理', 'fa fa-wechat', '', '', 1, 1548215982, 1548215982, 0, 'normal'),
	(131, 'file', 130, 'wechat/autoreply', '自动回复管理', 'fa fa-reply-all', '', '', 1, 1548215982, 1548215982, 0, 'normal'),
	(132, 'file', 131, 'wechat/autoreply/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(133, 'file', 131, 'wechat/autoreply/add', '添加', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(134, 'file', 131, 'wechat/autoreply/edit', '修改', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(135, 'file', 131, 'wechat/autoreply/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(136, 'file', 131, 'wechat/autoreply/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(137, 'file', 130, 'wechat/config', '配置管理', 'fa fa-cog', '', '', 1, 1548215982, 1548215982, 0, 'normal'),
	(138, 'file', 137, 'wechat/config/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(139, 'file', 137, 'wechat/config/add', '添加', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(140, 'file', 137, 'wechat/config/edit', '修改', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(141, 'file', 137, 'wechat/config/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(142, 'file', 137, 'wechat/config/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(143, 'file', 130, 'wechat/menu', '菜单管理', 'fa fa-list', '', '', 1, 1548215982, 1548215982, 0, 'normal'),
	(144, 'file', 143, 'wechat/menu/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(145, 'file', 143, 'wechat/menu/add', '添加', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(146, 'file', 143, 'wechat/menu/edit', '修改', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(147, 'file', 143, 'wechat/menu/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(148, 'file', 143, 'wechat/menu/sync', '同步', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(149, 'file', 143, 'wechat/menu/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(150, 'file', 130, 'wechat/response', '资源管理', 'fa fa-list-alt', '', '', 1, 1548215982, 1548215982, 0, 'normal'),
	(151, 'file', 150, 'wechat/response/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(152, 'file', 150, 'wechat/response/add', '添加', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(153, 'file', 150, 'wechat/response/edit', '修改', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(154, 'file', 150, 'wechat/response/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(155, 'file', 150, 'wechat/response/select', '选择', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(156, 'file', 150, 'wechat/response/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(157, 'file', 0, 'command', '在线命令管理', 'fa fa-terminal', '', '', 1, 1548215982, 1548215982, 0, 'normal'),
	(158, 'file', 157, 'command/index', '查看', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(159, 'file', 157, 'command/add', '添加', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(160, 'file', 157, 'command/detail', '详情', 'fa fa-circle-o', '', '', 0, 1548215982, 1548215982, 0, 'normal'),
	(161, 'file', 157, 'command/execute', '运行', 'fa fa-circle-o', '', '', 0, 1548215983, 1548215983, 0, 'normal'),
	(162, 'file', 157, 'command/del', '删除', 'fa fa-circle-o', '', '', 0, 1548215983, 1548215983, 0, 'normal'),
	(163, 'file', 157, 'command/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1548215983, 1548215983, 0, 'normal');
/*!40000 ALTER TABLE `fa_auth_rule` ENABLE KEYS */;

-- 导出  表 myfastadmin.fa_category 结构
...
-- 正在导出表  myfastadmin.fa_category 的数据：~13 rows (大约)
...
-- 导出  表 myfastadmin.fa_command 结构
...
-- 正在导出表  myfastadmin.fa_config 的数据：~17 rows (大约)
...
-- 正在导出表  myfastadmin.fa_test 的数据：~0 rows (大约)
...
-- 正在导出表  myfastadmin.fa_user 的数据：~0 rows (大约)
...
-- 导出  表 myfastadmin.fa_user_group 结构
...
-- 正在导出表  myfastadmin.fa_user_group 的数据：~0 rows (大约)
...
-- 导出  表 myfastadmin.fa_user_money_log 结构
...
-- 正在导出表  myfastadmin.fa_user_rule 的数据：~12 rows (大约)
...
-- 导出  表 myfastadmin.fa_user_score_log 结构
...
-- 正在导出表  myfastadmin.fa_version 的数据：~0 rows (大约)
...
-- 导出  表 myfastadmin.fa_wechat_autoreply 结构
...
-- 正在导出表  myfastadmin.fa_wechat_autoreply 的数据：~2 rows (大约)
...
-- 导出  表 myfastadmin.fa_wechat_config 结构
...
-- 正在导出表  myfastadmin.fa_wechat_config 的数据：~3 rows (大约)
...
-- 导出  表 myfastadmin.fa_wechat_context 结构
...
-- 正在导出表  myfastadmin.fa_wechat_response 的数据：~5 rows (大约)
...
-- 导出  表 myfastadmin.fa_zhomepage_config 结构
CREATE TABLE IF NOT EXISTS `fa_zhomepage_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `type` enum('1','2') NOT NULL DEFAULT '1' COMMENT '图片类型:1=首页轮播,2=首页中部',
  `title` varchar(100) NOT NULL DEFAULT '''''' COMMENT '标题',
  `image` varchar(200) NOT NULL DEFAULT '''''' COMMENT '图片',
  `link_url` varchar(200) NOT NULL DEFAULT '''''' COMMENT '图片超链接',
  `weigh` int(11) NOT NULL DEFAULT '0' COMMENT '排序(小的在前)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='首页配置';

-- 正在导出表  myfastadmin.fa_zhomepage_config 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `fa_zhomepage_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `fa_zhomepage_config` ENABLE KEYS */;

-- 导出  表 myfastadmin.fa_zuser 结构
CREATE TABLE IF NOT EXISTS `fa_zuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `email` varchar(100) NOT NULL COMMENT '用户邮箱账号',
  `password` varchar(32) NOT NULL COMMENT '登录密码',
  `c_id` int(11) NOT NULL COMMENT 'CRM_ID',
  `create_time` int(11) NOT NULL COMMENT '注册时间',
  `is_pay` int(11) NOT NULL DEFAULT '0' COMMENT '是否注册付款(true/false默认)',
  `complete_time` int(11) NOT NULL DEFAULT '0' COMMENT '注册完成时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`),
  UNIQUE KEY `c_id` (`c_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户表';

-- 正在导出表  myfastadmin.fa_zuser 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `fa_zuser` DISABLE KEYS */;
/*!40000 ALTER TABLE `fa_zuser` ENABLE KEYS */;
